#!/bin/bash
#SBATCH -A MLS
#SBATCH -J nc_cnn_n64_x3_z_0.1_1314
...
python $exe_python tune -n $n_threads -f $param_file -o $output_dir &> ${output_dir}/logs/tune_13.log &
python $exe_python tune -n $n_threads -f $param_file -o $output_dir &> ${output_dir}/logs/tune_14.log &
